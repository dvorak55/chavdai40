...
3. 予備の電子部品（ダイオード2個）　　←組立時には不要だと思いますが、念の為に同梱しています
4. 問い合わせ先が記載された紙　1枚　　←ご不明点ありましたらこちらへお願いいたします  
※2020年9月13日以降にご購入された「rev2」と記載されたキットの場合、基板を改良し不要となったため、予備の電子部品は同梱しておりません。  
...
もちろん、マスキングテープやシートは、カモ井加工紙のモノ以外でも問題なく使用できます。  
...
※おそらく、100円ショップ等で売っているデコレーション用シールも使うことができると思いますが、未検証です。また、あまり分厚いシールを使うと、キースイッチを挿す時にきつくなってしまいますのでご注意ください。  
